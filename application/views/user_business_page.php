...
<section id = "location" style="display: none;">
	<p class = "BA-green medium-font-size no-margin">Slogan</p>
	<p class = "BA-dark-orange margin-bottom-std"><?php echo $biz_info->biz_slogan; ?></p>
	<p class = "BA-green medium-font-size no-margin">Business Field(s)</p>
	<p class = "BA-dark-orange margin-bottom-std"><?php echo $biz_info->biz_main_field; ?></p>	
	<?php if ($location != "no_location"): ?>
        <p class = "BA-green medium-font-size no-margin">Local directions</p>
        <p class = "BA-dark-orange margin-bottom-std">
        <?=$location->loc_description?>	
        </p>				
    <?php else: ?> 
    	<p class = "BA-green medium-font-size no-margin">Locations</p>
        <p class = "BA-dark-orange margin-bottom-std">
        	<ul>
        	<?php foreach ($locations->result() as $location): ?>
        		<li class = "BA-dark-orange"><?=$location->loc_district . ", " . $location->loc_area . ", " . $location->loc_description?></li><br>
            <?php endforeach; ?>
            <ul>	
        </p>
    <?php endif; ?> 		
...
<section class = "modal-BG">
	<section class = "modal-frame">
        <div id = "user-view-product">
        <span class = "hover-green close-window-btn">&#10060;</span>
            ...
            <div id = "modal-frame-body" class = "side-by-side-cont">
                ...
                <div class = "margin-top-std">
                    <button id = "modal-user-place-order-btn" class = "BA-button small-font-size">Place Order</button>
                    <button id = "modal-user-send-email-btn" class = "BA-button small-font-size">Email Enquiry</button>
                </div>
                </section>
    ...
    <div id = "user-capture-contacts" class = "hidden">
        <span class = "hover-green close-window-btn">&#10060;</span>
        <p class = "title-strip h-font-size margin-bottom-std">PRODUCT INFO</p>
        <section class = "margin-top-std _80p-width-center pos-relative">      
            ...
            <div class = "center-bottom-btn">
            	<input type = "submit" value = "Submit" class = "BA-button medium-font-size">
                <button class = "BA-button medium-font-size user-prd-view-back-btn">Back</button> 
            </div>    
        </section>
     </div>
     <div id = "user-send-email" class = "hidden">
        <span class = "hover-green close-window-btn">&#10060;</span>
        <p class = "title-strip h-font-size margin-bottom-std">PRODUCT INFO</p>
        <section class = "margin-top-std _80p-width-center-rwd pos-relative">                   
